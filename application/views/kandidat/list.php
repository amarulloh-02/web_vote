   ...
   <main class="app-content bg-white">
      ...
      <div class="row">
         <div class="col-lg-12 col-md-12">
            ...
            <a href="<?= base_url('kandidat/tambah') ?>" class="btn btn-success mb-2"><i class="fa fa-plus"></i> Tambah</a>
                  ...
                  <tbody>
                     <?php foreach ($kandidat as $key => $value) { ?>
                        <tr>
                           ...
                           <td>
                              <a href="<?= base_url('kandidat/edit/' . $value->id_kandidat) ?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                              <a href="<?= base_url('kandidat/delete/' . $value->id_kandidat) ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin hapus data ini ?')"><i class="fa fa-trash"></i> Hapus</a>
                           </td>
                        <?php } ?>
                        </tr>
                  </tbody>
