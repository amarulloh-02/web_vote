            ...
            <div class="panel panel-primary">
               ...
               <div class="panel-body">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="nama_pemilih" class="form-control" placeholder="Nama Pemilih" value="<?= $pemilih->nama_pemilih ?>" autofocus>
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="username" class="form-control" placeholder="Username" value="<?= $pemilih->username ?>" readonly>
